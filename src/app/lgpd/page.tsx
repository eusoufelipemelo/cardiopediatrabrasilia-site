...
export const metadata: Metadata = pageMetadata({
  ...
  description: "Como exercer seus direitos de titular de dados pessoais junto à Dra. Michelle Sanches, conforme a Lei Geral de Proteção de Dados (Lei nº 13.709/2018).",
  path: "/lgpd",
});
...
export default function LgpdPage() {
  ...
  return (
    <LegalPage title="LGPD: seus direitos" path="/lgpd" intro="A Lei Geral de Proteção de Dados garante a você controle sobre os seus dados pessoais. Veja como exercer esses direitos.">
      ...
      <p>De acordo com o art. 18 da LGPD, você pode pedir à Dra. Michelle Sanches, a qualquer momento, inclusive em nome da criança de quem você é responsável:</p>
      <ul>
        <li>Confirmação de que há tratamento de dados seus;</li>
        ...
        <li>Informação sobre com quem os seus dados são compartilhados;</li>
      ...
      <p>
        ...
        , informando seu nome e o que deseja. Para proteger os seus dados, pode ser pedida uma confirmação de identidade antes do atendimento. Dados que fazem parte do prontuário médico seguem os prazos de guarda das normas da medicina.
      </p>
      <p>
        A resposta vem pelo mesmo canal. Pedidos de confirmação e de acesso em formato simplificado são respondidos imediatamente ou, quando for preciso
      ...
      <p>
        Os dados tratados, as finalidades e com quem são compartilhados estão na <Link href="/politica-de-privacidade">Política de Privacidade</Link>.
      </p>
    </LegalPage>
  );
}
